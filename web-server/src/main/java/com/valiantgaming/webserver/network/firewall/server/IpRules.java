package com.valiantgaming.webserver.network.firewall.server;
...
public class IpRules implements IpFilterRule
{
    ...
    public boolean matches(InetSocketAddress remoteAddress)
    {
        ...
        if(serverInfoList == null || serverInfoList.isEmpty())
        {
            ...
            if(WebServerConfig.getDbServerIp().equals(address[0]) && String.valueOf(WebServerConfig.getDbServerPort()).equals(address[1]))
            {
